...
export class ManagerService {
  ...
  public SessionExpiredEmitter = new EventEmitter<void>();
  ...
  editUserInfo(list: string[], param:string){
    return this.http.post(this.baseUrl + this.credentialsUrl,
      'sessionId=' + this.sessionId + '&user=' + this.getUser() + '&idData=' + list.join(';') + '&param=' + param,
      { headers: this.options });
  }
  ...
  getNews(){
    return this.http.post(this.baseUrl + this.listeUrl,
      'sessionId=' + this.sessionId + '&user=' + this.user + '&feed=y',
      { headers: this.options });
  }
  answerRequest(type:string, id:number, answer:string){
    return this.http.post(this.baseUrl + this.listeUrl,
      'sessionId=' + this.sessionId + '&user=' + this.user+ '&type=' + type+ '&id=' + id+ '&answer=' + answer + '&feed=y',
      { headers: this.options });
  }
